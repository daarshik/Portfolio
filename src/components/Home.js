  ...
  return (
    <>
      ...
      >
        ...
        />
        <ParallaxBannerLayer speed={-5} className=" z-50">
          <div className="flex sm:flex-col justify-center items-center text-white box-border  mt-40 ">
            <div className="ml-20 mt-40 text-2xl tracking-wider">
              <p>
                I'm <span style={{ fontWeight: "bold" }}>Daarshik</span>{" "}
                <span
              ...
              <p className="mt-3 text-gray-900">
                ...
                deserunt quasi hic labore eum sapiente mollitia unde enim
                molestias illum quae necessitatibus id quisquam tempora amet,
                eveniet, vero cumque ex tenetur recusandae corporis! Corrupti
                sed sit cumque non distinctio, autem modi error voluptas minima
                accusantium? Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Id dolor, velit neque officia sapiente a repudiandae, odio
                doloremque facilis quia eaque aliquid sunt labore nihil autem,
                amet rerum qui libero minus? Voluptatem nihil natus iusto
                maiores cum! Possimus aperiam, aspernatur beatae animi
                accusantium
              </p>
            </div>
            <div className="ml-20  mt-80  mr-20 p-35 w-[100%] box-border">
              <svg
          ...
          <Skills className=" mt-32 h-full" speed={-20} />
        </ParallaxBannerLayer>
        <ParallaxBannerLayer
          image={Image3}
          speed={-40}
